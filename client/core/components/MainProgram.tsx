    ...
    return (
      ...
      <div className="container-fluid" id="game">
        ...
        <div className="parchment">
          <div className="parchment-inner">Waking up the monsters...</div>
        </div>
      </div>
    );
  }
        ...
        <div className={`command col-md-7 ${historyClass}`}>
          <div className="parchment">
            <div className="parchment-inner">
              ...
              {game.modal.visible && <Question game={game} setGameState={setGameState} />}
            </div>
          </div>
        </div>
        ...
        <div id="menu" className={"container-fluid " + menuClass}>
          <div className="row">
            <ul>
              ...
              <li>
                <a href="https://github.com/kdechant/eamon" target="_blank" rel="noopener">
                  Source Code
                </a>
              </li>
              <li>
                <a href="https://github.com/kdechant/eamon/issues" target="_blank" rel="noopener">
                  Report a Bug
                </a>
              </li>
              <li>
                <a href="https://www.kdechant.com/">About the Author</a>
              </li>
              <li>
    ...
    <div className="container-fluid main-heading">
      <div className="row no-gutters">
        ...
        <div className="player-name col-4 text-right">
          <span>
            {game.player.name}
            <br />({game.player.hardiness - game.player.damage}/{game.player.hardiness})
          </span>
        </div>
          ...
          <button type="button" aria-haspopup={true} aria-expanded={props.statusOpen} onClick={props.toggleStatus}>
            {props.statusOpen ? (
              <img
                ...
                alt="Backpack Icon - Opens status screen"
                title="View Status"
              />
            ) : (
              <img
                src="/static/images/ravenmore/128/backpack_open.png"
                alt="Backpack Icon - Closes status screen"
                title="Hide Status"
              />
            )}
          </button>
