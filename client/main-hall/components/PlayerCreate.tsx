...
const PlayerCreate: React.FC = (): JSX.Element => {
  ...
  const handleSubmit = (event) => {
    ...
    setError("");
    axios
      .post("/api/players", player, { headers: getHeaders() })
      .then((res) => {
  ...
  if (playerId) {
    return (
      <div className="col-sm-12 PlayerCreate">
        <div className="prosper">
          <p>
            The man behind the desk says, &quot;Welcome, {name}. It is now time for you to begin your adventures. Your
            first task will be to buy weapons and armor and test your skill on a suitable Beginner adventure.&quot;
          </p>
  ...
  return (
    <div className="col-sm-12 PlayerCreate">
      <p>
        The burly Irishman hits his forehead and says, &quot;Ah, ye must be new here! Well, wait just a minute and I'll
        bring someone out to take care of ye.&quot;
      </p>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="row margin-bottom-md">
          <div className="col-sm-2">
            <label>
              <input name="gender" type="radio" value="m" checked={gender === "m"} onChange={handleChange} /> Male
            </label>
          </div>
          <div className="col-sm-2">
            <label>
              <input name="gender" type="radio" value="f" checked={gender === "f"} onChange={handleChange} /> Female
            </label>
          </div>
        </div>
        ...
        <div className="row margin-bottom-md">
          <div className="col-sm-4 col-lg-3 text-center">
            ...
            <p>
              <small>Hit points. Also determines how much you can carry.</small>
            </p>
          </div>
          <div className="col-sm-4 col-lg-3 text-center">
            <p>
            ...
            <p>
              <small>Increases your chance to hit, and makes you harder to hit.</small>
            </p>
          </div>
          <div className="col-sm-4 col-lg-3 text-center">
            <p>
            ...
            <p>
              <small>Makes some monsters and NPCs more friendly.</small>
            </p>
          </div>
        </div>
