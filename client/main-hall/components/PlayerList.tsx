...
const PlayerList = () => {
  ...
  return (
    <div className="PlayerList">
      <p>
        You are in the outer chamber of the hall of the Guild of Free Adventurers. Many men and women are guzzling beer
        and there is loud singing and laughter.
      </p>
      <p>
        On the north side of the chamber is a cubbyhole with a desk. Over the desk is a sign which says:{" "}
        <strong>&quot;REGISTER HERE OR ELSE!&quot;</strong>
      </p>
      ...
      {empty_message}
      <p className="addplayer">
        <Link to="/main-hall/register">
          <strong>Create a New Adventurer</strong>
        </Link>
      </p>
      ...
      {!!players.length && profile && (
        <div className="card" style={{ background: "transparent" }}>
          <div className="card-body">
            <p>
              Your Main Hall Access Code is: <strong>{profile.slug}</strong>
            </p>
            <p>
              Your adventurers will automatically be linked to your current browser and computer. If you plan to use a
              different browser or computer, you will need to remember this Access Code. You can use it on the other
              computer to load your adventurers.
            </p>
            <p>You can bookmark this link to load your adventurers on a different computer or browser:</p>
            <p>
              <a href={`https://eamon-remastered.com/main-hall?code=${profile.slug}`}>
                https://eamon-remastered.com/main-hall?code={profile.slug}
              </a>
            </p>
      ...
      {!players.length && (
        <div className="card" style={{ background: "transparent" }}>
          <div className="card-body">
            <p>
              Returning from another computer or browser? Enter your Main Hall Access Code to load your adventurers:
            </p>
            ...
            {accessCodeError && <p className="danger">{accessCodeError}</p>}
          </div>
        </div>
      )}
        ...
        <ModalBody>
          <div className="row">
            <div className="col-12">
              <p>
                The Irishman mentions something else to you. &quot;I see you're from the future, and you're visiting in
                a web browser. You should know that all the characters live up in this big sky computer. Your browser
                stores a special code that allows you to load your characters and play as them any time you want, as
                long as you use the same computer and the same browser.&quot;
              </p>
              <p>
                &quot;If you want to load your adventurers on a different computer or browser, you can enter your
                personal access code <strong>{profile.slug}</strong> to load them.&quot;
              </p>
              <p>
                &quot;You can keep your access code private, or share it with a friend. But, if you share it, your
                friend will be playing with the same characters. If they sell or break your favorite magic sword, don't
                blame me.&quot;
              </p>
              <p>
                &quot;And don't worry. I know that you Free Adventurers might have colorful pasts and you might not want
                other people to know you're here. Here in Eamon, we never sell or give away any information about our
                adventurers, not even to our local armourer or wizard. Your information is safe here.&quot;
              </p>
              <p>
