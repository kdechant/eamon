...
import type { SavedGame } from "../models/player";
  ...
  const deleteSavedGame = () => {
    if (confirm("Are you sure you want to delete this saved game?")) {
      ...
      setTimeout(() => {
        ...
        axios
          .delete("/api/saves/" + props.savedGame.id + ".json?uuid=" + uuid, { headers: getHeaders() })
          .then(() => {
    ...
    <div className="artifact-tile col-sm-6 col-md-4 col-lg-3">
      <div className="artifact-tile-inner">
        <div className="artifact-icon">
          <img src="/static/images/ravenmore/128/map.png" title={props.savedGame.description} alt="" />
        </div>
        ...
        <div className="artifact-data">
          <p>
            Save #{props.savedGame.slot}: {props.savedGame.description}
          </p>
        </div>
        <div className="artifact-buttons">
          <button type="button" className="btn btn-primary" onClick={loadSavedGame}>
            Resume
          </button>
          <button type="button" className="btn btn-warning" onClick={deleteSavedGame}>
            Delete
          </button>
        </div>
