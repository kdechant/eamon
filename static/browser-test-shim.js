...
Error.stackTraceLimit = 2; // "No stacktrace"" is usually best for app testing.
...
System.config({
  ...
  packages: {
      ...
      'core': { main: './main.js', defaultExtension: 'js' },
      'adventure': { main: './main.js', defaultExtension: 'js' }
  },
...
System.import(core_path + '/systemjs.config.js')
...
function importSystemJsExtras(){
  return System.import(core_path + '/systemjs.config.extras.js')
